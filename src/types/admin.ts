...
const CityTemplate: React.FC = () => {
  // Scroll vers le haut à chaque chargement de page
  useScrollToTop();
  ...
  console.log('City param:', city); // Debug
  ...
  React.useEffect(() => {
    try {
      ...
      console.log('Loaded city pages:', pages); // Debug
      setCityPages(pages);
    } catch (error) {
  ...
  console.log('Final city name:', cityName); // Debug
  console.log('Final city data:', cityData); // Debug
  ...
  const services = [
    ...
    },
    {
      ...
      description: `Service de dépannage électrique avec tarif fixe 110€ HT à ${cityName}. Intervention rapide pour tous vos problèmes électriques.`,
      icon: Clock,
      details: [
        'Tarif fixe 110€ HT pour 1h',
  ...
  return (
    <div>
      ...
      <head>
        ...
        <meta name="keywords" content={`électricien ${cityName}, installation électrique ${cityName}, dépannage électrique ${cityName}, ${cityInfo.codePostal}, ${cityInfo.departement}`} />
      </head>
            ...
            <div className="space-y-8">
                ...
                <div className="bg-blue-800 bg-opacity-50 backdrop-blur-sm rounded-lg p-4 border border-blue-600">
                  <div className="flex items-center space-x-4 text-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <span>{cityInfo.codePostal} {cityName}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className="text-blue-300">•</span>
                      <span>{cityInfo.departement}</span>
                    </div>
                    {cityInfo.population && (
                      <>
                        <div className="flex items-center space-x-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-blue-100">Dépannage 110€ HT</span>
                </div>
                <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <Link 
                  to="/contact" 
                  className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-lg font-bold text-lg transition-colors text-center shadow-lg"
                >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Dépannage électrique à {cityName} avec tarif fixe 110€ HT. 
            ...
            <div className="bg-gray-800 p-8 rounded-2xl">
              <div className="grid md:grid-cols-3 gap-8">
                <div className="space-y-2">
                  ...
                  <h3 className="font-semibold">Dépannage 110€ HT</h3>
                  <p className="text-gray-300 text-sm">Tarif fixe 1h à {cityName}</p>
                </div>
                <div className="space-y-2">
            ...
            <div className="space-y-4">
              ...
              {dynamicCity && (
                <div className="mt-4 text-xs text-gray-500">
                  Page créée via le dashboard admin
                  {cityInfo.codePostal && ` • ${cityInfo.codePostal}`}
                  {cityInfo.departement && ` - ${cityInfo.departement}`}
                </div>
              )}
            </div>
          </div>
